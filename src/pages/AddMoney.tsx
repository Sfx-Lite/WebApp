        ...
        <div className="w-full md:max-w-[50%] mx-auto space-y-2">
          ...
          <div className="w-full space-y-4">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-2xl bg-sfx-primary-tint sm:size-16">
                ...
                <ChevronRight className="size-6 text-sfx-muted" />
              </div>
            </button>
            <button
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-2xl bg-sfx-success-bg sm:size-16">
            ...
            <button
              ...
              className={`w-full p-(--spacing-card-pad) bg-sfx-card rounded-card ${isDisabled ? "opacity-70 cursor-not-allowed!" : "opacity-100 cursor-pointer"}`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-2xl bg-sfx-amber-bg sm:size-16">
                  ...
                  <div className="space-y-1 text-left">
                    <h3 className="font-rh-b text-[16px] leading-[16px]">
                      Local bank
                      {" "}
                      <span className="inline-block px-2 py-1 rounded-full bg-sfx-amber-bg text-[14px] font-rh-m text-sfx-amber">Coming soon</span>
                    </h3>
                    <p className="text-[15px] leading-[18px] text-sfx-muted ">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="flex size-14 items-center justify-center rounded-2xl bg-sfx-danger-bg sm:size-16">
